...
sed -i "s/securitymonkeypassword/$db_pass/g" /home/ubuntu/security_monkey/env-config/config-deploy.py

RANDOM1=$(cat /dev/urandom | tr -dc 'a-zA-Z' | fold -w 32 | head -n 1)
sed -i "0,/<INSERT_RANDOM_STRING_HERE>/s//$RANDOM1/" /home/ubuntu/security_monkey/env-config/config-deploy.py
RANDOM2=$(cat /dev/urandom | tr -dc 'a-zA-Z' | fold -w 32 | head -n 1)
sed -i "0,/<INSERT_RANDOM_STRING_HERE>/s//$RANDOM2/" /home/ubuntu/security_monkey/env-config/config-deploy.py
