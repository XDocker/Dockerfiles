...
SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:AVG9fQBG@localhost:5432/secmonkey'
...
DEFAULT_MAIL_SENDER = 'info@xervmon.com'
...
SECURITY_TEAM_EMAIL = 'support@xervmon.com'
